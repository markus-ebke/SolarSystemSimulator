...
bl_info = {
    ...
    "warning": "In developement, version from 20.09.2013",
    "wiki_url": "",
    "tracker_url": "",
    "category": "Object"}
...
def register():
    ...
    bpy.types.VIEW3D_PT_tools_objectmode.append(panels.tool_panel)


def unregister():
    bpy.types.PHYSICS_PT_add.remove(panels.physics_panel)
    bpy.types.VIEW3D_PT_tools_objectmode.remove(panels.tool_panel)
